...
I am a Machine Learning–focused engineering student building end-to-end ML systems — from data preprocessing and feature engineering to model training, evaluation, and deployment as usable services.
...
### 🔹 **Self-Healing ML System — End-to-End MLOps Lifecycle (AWS | 24/7 Live)**
...
### 🔹 **Student Performance Prediction — Random Forest (ML Fundamentals)**
...
### 🔹 **Linear Regression System — Baseline Modeling & Evaluation**

**Core Focus:** ML fundamentals, baselines, regression analysis

* Implemented a **Linear Regression–based prediction system**
...
### 🔹 **Spam Classification System — Logistic Regression (ML + NLP Basics)**
...
- Focused on correctness, edge-case handling, and time–space trade-offs
...
### AIML Virtual Internship — Adverk Technologies
